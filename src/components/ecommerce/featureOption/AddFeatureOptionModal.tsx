import FeatureOptionForm from "./FeatureOptionForm";

interface AddFeatureOptionModalProps {
  show: boolean;
  onClose: () => void;
...
export default function AddFeatureOptionModal({
  show,
  onClose,
  featureOptionId,
  featureId
}: AddFeatureOptionModalProps) {
        ...
        <div className="sticky top-0 z-10 border-b border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              {featureOptionId ? 'ویرایش گزینه ویژگی' : 'افزودن گزینه ویژگی جدید'}
            </h3>
            <button
              onClick={onClose}
