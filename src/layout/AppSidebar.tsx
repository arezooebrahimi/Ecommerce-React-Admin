...
const navItems: NavItem[] = [
  ...
  },
  {
    name: "فرم‌ها",
    icon: <ListIcon />,
    subItems: [{ name: "عناصر فرم", path: "/form-elements", pro: false }],
  },
  {
    name: "جداول",
    icon: <TableIcon />,
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "خطای 404", path: "/error-404", pro: false },
    ],
  },
];
...
const othersItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "آواتار", path: "/avatars", pro: false },
